                ...
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td align="right" width="30%">
                                ...
                                <a onClick={() => setLangSelected("ch")}><img src="img/ch.png" className="flag-image-d" style={{paddingLeft: 2, paddingRight: 2}}/></a>
                                <a onClick={() => setLangSelected("jp")}><img src="img/jp.png" className="flag-image-d" style={{paddingLeft: 2, paddingRight: 2}}/></a>
                                <a onClick={() => setLangSelected("em")}><img src="img/em.png" className="flag-image-d" style={{paddingLeft: 2, paddingRight: 2}}/></a>
                        </td>
                    </tr>
                    </tbody>
                </table>
